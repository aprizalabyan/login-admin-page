<template>
  <section id="subscribe" class="d-flex align-items-center py-5 mb-5">
    <div class="subscribe d-flex flex-column flex-md-row justify-content-between align-items-center p-5 gap-4 gap-md-0">
      ...
      <div class="col-10 col-md-6 col-lg-4 d-flex justify-content-center justify-content-md-end align-items-center me-4">
        <button class="btnSubs">Subscribe Now</button>
      </div>
    </div>
  </section>
</template>
